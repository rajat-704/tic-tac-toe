...
class four extends React.Component {
    ...
    onTilePress = (row, col) => {
        ...
        if (win == 1) {
            ...
            ToastAndroid.show("Player 3 Won", ToastAndroid.LONG, ToastAndroid.BOTTOM);
            this.initializeGame();
        }
        else if (win == 2) {
    ...
    renderIcon = (row, col) => {
        ...
        switch (value) {
            ...
            case 10:
                return <Icon name="check" style={styles.tileO} />;
            default:
                return <View />;
        }
    }
